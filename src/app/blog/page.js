...
export const metadata = {
    title: "Blog — Dummy Ticket Guides & Travel Tips",
    description: "Expert guides on dummy tickets, visa applications, and travel tips. Learn how to use dummy tickets for Schengen, UK, US visas and proof of onward travel.",
    openGraph: {
        ...
        <div className="min-h-screen pt-28 pb-20 px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-5xl">
                <div className="text-center mb-14">
                    ...
                    <p className="text-slate-500 max-w-lg mx-auto">Everything you need to know about dummy tickets and visa applications.</p>
                </div>
